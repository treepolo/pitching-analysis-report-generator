...
test('entry intro runtime is valid JavaScript and schedules the ident sound and finish', () => {
  ...
  assert.match(source, /treepolo:intro-ident-complete/u);
  assert.match(source, new RegExp(`setTimeout\\(finish,${IDENT_DURATION_MS}\\)`,'u'));
});
