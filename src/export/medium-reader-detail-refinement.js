...
/* Medium-style hierarchy: sections are separated by whitespace and partial rules,
   not boxed panels. */
html body>main section.report-section{position:relative!important;margin:0 0 12px!important;padding:8px 5px 18px!important;border:0!important;border-radius:0!important;background:transparent!important;box-shadow:none!important}
html body>main section.report-section+section.report-section{margin-top:14px!important;padding-top:24px!important}
html body>main section.report-section+section.report-section::before{content:"";position:absolute;top:0;left:5px;width:min(38%,360px);height:1px;background:#cfcfcf}
html body>main section.report-section>h2{position:relative;margin:0 0 16px!important;padding:0 0 11px!important;border:0!important;background:transparent!important;box-shadow:none!important;color:#242424!important;font-size:20px!important;font-weight:700!important;line-height:1.28!important;letter-spacing:-.01em!important}
html body>main section.report-section>h2::after{content:"";display:block;width:64px;height:2px;margin-top:9px;border-radius:999px;background:#1a8917}

/* Player headings get their own lower level in the visual hierarchy. */
html body>main .portable-player-header{margin-bottom:9px!important;padding-bottom:8px!important;border-bottom:1px solid #e6e6e6!important}
html body>main .portable-player-header h3{color:#242424!important;font-size:17px!important;font-weight:700!important;line-height:1.3!important;letter-spacing:-.005em!important}
html body>main .portable-player-side-heading h3{color:#242424!important;font-size:15px!important;font-weight:650!important;line-height:1.3!important}
