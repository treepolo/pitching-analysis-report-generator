...
function renderStyles() {
  return `
    ...
    * { box-sizing: border-box; }
    ...
    /* Windows XP/Windows 7 desktop application theme: authentic menu, toolbar and panel chrome. */
    :root { color-scheme: light; font-family: Tahoma, "MS Sans Serif", Arial, sans-serif; }
    html { min-height: 100%; background: #ece9d8; }
    body { min-height: 100vh; background: #ece9d8; color: #1f2d3d; font: 11px/1.35 Tahoma, "MS Sans Serif", Arial, sans-serif; }
    main { width: min(100% - 1rem, 1100px); margin: 0 auto 18px; padding: 0 8px 18px; background: #f5f5f5; border: 1px solid #7f9db9; border-top: 0; border-radius: 0 0 3px 3px; box-shadow: 0 1px 4px rgba(42,65,87,.25); }
    .report-header { margin: 0 -9px 8px; padding: 5px 8px; background: linear-gradient(180deg, #5c9bd5 0%, #2f73b5 47%, #123e79 100%); color: #fff; border: 0; border-bottom: 1px solid #0c2c57; border-radius: 0; box-shadow: inset 0 1px 0 rgba(255,255,255,.45), 0 1px 3px rgba(0,0,0,.3); }
    .report-header .eyebrow { margin: 0; color: #fff; font-size: 10px; font-weight: bold; letter-spacing: normal; text-shadow: 0 1px 1px #123e79; }
    .report-header h1 { margin: 0; color: #fff; font-size: 20px; line-height: 1.2; text-shadow: 0 1px 1px #123e79; }
    h1, h2, h3, h4 { line-height: 1.2; letter-spacing: normal; color: #1f2d3d; }
    h2 { margin: 0 0 6px; font-size: 15px; }
    h3 { margin: 0 0 5px; font-size: 13px; }
    h4 { margin: 7px 0 3px; font-size: 11px; }
    .report-section { margin: 0 0 8px; padding: 8px; border: 1px solid #7f9db9; border-radius: 2px; background: #fff; box-shadow: none; }
    .report-section > h2 { margin: -8px -8px 7px; padding: 3px 6px; border-bottom: 1px solid #9aafc4; background: linear-gradient(180deg, #e8f2fc 0%, #bfd3e7 100%); font-size: 13px; }
    .report-text { color: #1f2d3d; line-height: 1.4; }
    .muted, figcaption { color: #536577; font-size: 10px; }
    .report-media { margin: 6px 0 0; }
    .report-media video, .report-media img { border: 1px solid #536f89; border-radius: 2px; background: #101820; box-shadow: inset 0 1px 3px rgba(0,0,0,.45); }
    .report-media img { background: #ece9d8; }
    .comparison-media { gap: 6px; }
    .portable-player { padding: 8px; border: 2px groove #d4d0c8; border-radius: 2px; background: #fff; box-shadow: inset 0 1px 0 #fff; }
    ...
    .portable-player-side { padding: 6px; border: 1px solid #9aafc4; border-radius: 2px; background: #ece9d8; }
    .portable-player[data-frame-selected="true"] { outline: 2px solid #316ac5; outline-offset: 1px; box-shadow: 0 0 0 2px rgba(49,106,197,.2); }
    .portable-player-side-heading { margin-bottom: 4px; }
    .portable-player-side-heading h3 { font-size: 12px; }
    .portable-player-side-heading span { color: #536f89; font-size: 10px; }
    .portable-frame-surface { min-height: 170px; border: 1px solid #536f89; border-radius: 2px; background: #101820; box-shadow: inset 0 1px 3px rgba(0,0,0,.45); }
    .portable-frame-side-status, .portable-frame-fallback { margin: 4px 0 0; color: #536577; font-size: 10px; }
    .portable-frame-controls { column-gap: 4px; row-gap: 4px; margin-top: 6px; }
    button, .portable-frame-controls button, .portable-player-rate-row button, .portable-frame-rate-row button, .portable-player-actions button { min-height: 23px; padding: 3px 7px; border: 2px outset #f1f1ea; border-radius: 2px; background: linear-gradient(180deg, #fff 0%, #ece9d8 47%, #d4d0c8 100%); color: #1f2d3d; box-shadow: inset 0 1px 0 #fff; font: 11px/1.2 Tahoma, "MS Sans Serif", Arial, sans-serif; cursor: pointer; text-shadow: 0 1px #fff; }
    button:hover:not(:disabled), .portable-frame-controls button:hover:not(:disabled), .portable-player-rate-row button:hover:not(:disabled), .portable-frame-rate-row button:hover:not(:disabled), .portable-player-actions button:hover:not(:disabled) { background: linear-gradient(180deg, #fff 0%, #e4f0fb 47%, #c2d9ed 100%); color: #123e79; }
    button:active:not(:disabled), .portable-frame-controls button:active:not(:disabled), .portable-player-rate-row button:active:not(:disabled), .portable-frame-rate-row button:active:not(:disabled), .portable-player-actions button:active:not(:disabled) { border-style: inset; }
    .portable-frame-controls output, .portable-player-side-controls output { color: #536f89; font-size: 11px; }
    .portable-frame-player-status { color: #536577; font-size: 10px; }
    .portable-frame-controls .portable-frame-player-status[data-state="loaded"], .portable-frame-controls .portable-frame-player-status[data-state="pending"] { color: #536577; }
    ...
    .portable-player-rate-reset, .portable-frame-rate-row button { width: 24px; height: 23px; min-height: 23px; border-radius: 2px !important; font-size: 13px; }
    ...
    input:not([type="checkbox"]):not([type="radio"]):not([type="range"]), select, textarea { min-height: 23px; padding: 3px 5px; border: 1px solid #7f9db9; border-radius: 1px; background: #fff; color: #1f2d3d; box-shadow: inset 0 1px 2px rgba(0,0,0,.16); }
    input[type="range"] { accent-color: #316ac5; }
    input:focus, select:focus, textarea:focus { border-color: #316ac5; box-shadow: 0 0 0 1px #8eb2df, inset 0 1px 2px rgba(0,0,0,.16); }
    ...
    @media (max-width: 700px) {
      main { width: calc(100% - .5rem); padding: 0 5px 12px; }
      .report-header { margin-inline: -6px; }
      .report-section { padding: 6px; }
      .report-section > h2 { margin: -6px -6px 6px; }
    }
