...
@media(max-width:700px){.tree-polo-footer{margin:48px 8px 0;padding:30px 12px 24px}.tree-polo-footer-message{font-size:19px;margin-bottom:21px}.tree-polo-promotion{margin-bottom:24px}.tree-polo-promotion-links{gap:6px}.tree-polo-promotion-link{gap:6px;min-height:52px;padding:10px 6px;font-size:11px}.tree-polo-promotion-icon,.tree-polo-promotion-icon svg{width:20px;height:20px}.tree-polo-footer-logo{height:26px}}
